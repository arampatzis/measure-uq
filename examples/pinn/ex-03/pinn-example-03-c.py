...
def main():
    ...
    conditions_train = [
        Condition1(points=torch.load("p1_train.tp")),
        Condition2(points=torch.load("p2_train.tp")),
    ]
    conditions_test = [
        Condition1(points=torch.load("p1_test.tp")),
        Condition2(points=torch.load("p2_test.tp")),
    ]
