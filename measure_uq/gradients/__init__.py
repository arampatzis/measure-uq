...
The functions in this subpackage are used for computing gradients of the loss
function of a model with respect to the parameters of the model.

The functions in this subpackage are a modification of the `gradients` module,
